...
Indigo – это React-подобная библиотека для построения пользовательских интерфейсов использующая HTML-шаблоны вместо JSX и написанная на TypeScript и для TypeScript..
